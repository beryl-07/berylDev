...
export default function Home() {
  ...
  return (
    <div onMouseMove={onMouseMove} className="bg-slate-900 leading-relaxed text-slate-400 antialiased selection:bg-teal-300 selection:text-teal-900 min-h-screen max-w-screen-xl py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0 md:flex md:justify-end md:relative">
