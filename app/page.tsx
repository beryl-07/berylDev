...
export default function Home() {
  ...
  return (
    <div onMouseMove={onMouseMove} className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0 md:flex md:justify-end md:relative">
